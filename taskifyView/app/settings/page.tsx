...
import { User, Mail, Lock, Shield, LogOut, Loader2, CheckCircle2 } from "lucide-react"
import { useAuthStore } from "@/lib/auth-store"

export default function SettingsPage() {
  const router = useRouter()
  const { user, logout, isLoading, isAuthenticated, checkAuth, isInitialized, updateProfile, changePassword } = useAuthStore()
